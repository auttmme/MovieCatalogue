...
object DataDummy {
    ...
    fun generateDummyDetailMovie(movie: MovieEntity, favorited: Boolean): MovieEntity {
        movie.movieFavorited = favorited
        return movie
    }

    fun generateDummyDetailTvShow(tvShow: TvShowEntity, favorited: Boolean): TvShowEntity {
        tvShow.tvFavorited = favorited
        return tvShow
    }
}